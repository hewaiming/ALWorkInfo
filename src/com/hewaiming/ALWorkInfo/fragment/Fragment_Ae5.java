...
public class Fragment_Ae5 extends Fragment implements OnScrollListener {
	private View mView;
	...
	public Fragment_Ae5(List<Map<String, Object>> jXList,List<String>mDateBean,String mip,int mport) {
		this.JXList=jXList;
	...
	public void onAttach(Activity activity) {
		...
		mActivity.setHandler_Ae5(mHandler_Ae);
	}
	...
	private void init_adapter(Object data) {
		if (data.equals("")) {
			Toast.makeText(this.getActivity(), "没有获取到[效应情报表]前四次AE，可能无符合条件数据！", Toast.LENGTH_LONG).show();
			if (listBean_Ae != null) {
