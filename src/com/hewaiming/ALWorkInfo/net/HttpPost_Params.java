...
public class HttpPost_Params extends AsyncTask<String, Void, String> {
	...
	public HttpPost_Params() {

	}

	public HttpPost_Params(String url) {
		this.url = url;
	}

	public HttpPost_Params(String url, HttpGetListener listener, Context context, String areaId) {
		this.url = url;
